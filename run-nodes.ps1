# Moved to examples\ — forwarding for convenience.
& "$PSScriptRoot\examples\run-nodes.ps1" @args
...
# ── Seed dummy data ────────────────────────────────────────────────────────
# Wait for all nodes to be ready, then POST sample assets spread across nodes.
...
Write-Host ""
Write-Host "Seeding dummy data in 6 seconds..." -ForegroundColor Yellow
Start-Sleep -Seconds 6

# Helper: POST one asset and print result
function Post-Asset {
...
Write-Host ""
Write-Host "=== Alpha (Industrial Tools) ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Beta (HVAC & Building Systems) ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Gamma (Safety & Electrical) ===" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "=== Delta (Producer — Sensors & IoT) ===" -ForegroundColor Cyan
